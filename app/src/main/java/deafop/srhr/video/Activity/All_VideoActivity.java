...
public class All_VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        methods = new Methods(this, new InterAdListener() {
            ...
            public void onClick(int position, String type) {
                ...
                Intent intent = new Intent(All_VideoActivity.this, All_PlayerActivity.class);
    ...
    private void getData() {
        ...
        },methods.getAPIRequest(Setting.METHOD_All_VIDEO, page, "", "", "", "", "", "", "", "","","","","","","","", null));
        load.execute();
    }
    ...
    public void setAdapter() {
        if (!isScroll) {
            adapter = new AdapterVideo(All_VideoActivity.this,  arrayList,  new RecyclerViewClickListener() {
                @Override
