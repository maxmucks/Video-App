...
public class Most_viewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.most_view));
        ...
        methods = new Methods(this, new InterAdListener() {
            ...
            public void onClick(int position, String type) {
                ...
                Intent intent = new Intent(Most_viewActivity.this, All_PlayerActivity.class);
    ...
    public void setAdapter() {
        if (!isScroll) {
            adapter = new AdapterVideo(Most_viewActivity.this,  arrayList,  new RecyclerViewClickListener() {
                @Override
